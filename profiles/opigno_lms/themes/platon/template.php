...
/* main ul */
function platon_menu_tree__main_menu($variables) {
  return '<ul id="top-menu">' . $variables['tree'] . '</ul>';
}

/* inner ui */
function platon_menu_tree__main_menu_inner($variables) {
    return '<ul class="" role="menu">' . $variables['tree'] . '</ul>';
}

/* inner li */
function platon_menu_link__main_menu_inner($variables) {
...
/* main li */
function platon_menu_link__main_menu(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
