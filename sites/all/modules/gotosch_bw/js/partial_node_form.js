 ...
 */
Drupal.behaviors.gotoschBwPartialNodeForm = {
  attach: function (context, settings) {
    $('.quicktabs-tabs a', context).click(function(){
      var $activeTab = $('#quicktabs-container-gotosch_bw .quicktabs-tabpage:not(.quicktabs-hide)', context);
      ...
      var $form = $('.gotosch-bw-partial-node-form-' + $placeholder.data('bundle'), context);
 ...
 */
Drupal.behaviors.gotoschBwExpandableForm = {
  attach: function (context, settings) {
    $('.gotosch-bw-partial-node-form', context).once('gotoschBwExpandableForm', function () {
