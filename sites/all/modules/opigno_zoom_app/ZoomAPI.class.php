...
class ZoomAPI{
	...
	private $api_key = 'lr9l4H4NRZurP4q6Qpk43Q';
	private $api_secret = 'mXv32pGsQ1EnB5Jsa28NKk58RYMEFZ4e8jud';
	private $host_id = '0T6NngUsQ26sKOmAB7PFvw';
	...
	function sendRequest($calledFunction, $data){
		...
		*/
		...
		//drupal_set_message('en zoom api');
